...
class CuckooClock extends StatefulWidget {
  const CuckooClock({super.key});

  @override
  State<CuckooClock> createState() => _CuckooClockState();
}

class _CuckooClockState extends State<CuckooClock>
